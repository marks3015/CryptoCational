    ...
    def __init__(self):
        ...
        self.TRANSLATIONS = {
            "pt": {
                ...
                # RSA Page
                "menu_rsa": " RSA-OAEP",
                "app_title_rsa": "CryptoCational - RSA-OAEP",
                "rsa_home_title": "RSA-OAEP",
                "rsa_home_subtitle": "Criptografia assimétrica com padding OAEP",
                "rsa_btn_keygen": "Gerar Par de Chaves",
                "rsa_btn_encrypt": "Cifrar",
                "rsa_btn_decrypt": "Decifrar",
                "rsa_btn_sign_verify": "Assinar / Verificar",

                # RSA Keygen sub-page
                "rsa_keygen_title": "Geração de Chaves RSA-2048",
                "rsa_keygen_info": "Gera um par de chaves RSA de 2048 bits (dois primos de 1024 bits) com expoente público e=65537. A geração pode levar alguns segundos.",
                "rsa_keygen_btn": "Gerar Par de Chaves",
                "rsa_keygen_generating": "Gerando chaves... aguarde.",
                "rsa_keygen_done": "Par de chaves gerado com sucesso.",
                "rsa_pubkey_label": "Chave Pública (JSON — copie para usar na cifragem)",
                "rsa_privkey_label": "Chave Privada (JSON — guarde com segurança!)",
                "rsa_privkey_warning": "Nunca compartilhe sua chave privada.",
                "rsa_btn_copy_pub": "Copiar Chave Pública",
                "rsa_btn_copy_priv": "Copiar Chave Privada",

                # RSA Encrypt sub-page
                "rsa_encrypt_title": "Cifragem RSA-OAEP",
                "rsa_plaintext_label": "Texto para Cifrar",
                "rsa_plaintext_placeholder": "Digite a mensagem (máx. ~190 bytes para chave 2048-bit)...",
                "rsa_pubkey_input_label": "Chave Pública (cole o JSON)",
                "rsa_pubkey_input_placeholder": '{"n": "...", "exp": "..."}',
                "rsa_ciphertext_label": "Texto Cifrado (Base64)",
                "rsa_btn_do_encrypt": "Cifrar",
                "rsa_btn_copy_cipher": "Copiar Resultado",
                "rsa_msg_limit": "Limite de mensagem: ~190 bytes para chave de 2048 bits.",
                "rsa_err_no_text": "Insira a mensagem a ser cifrada.",
                "rsa_err_no_pubkey": "Cole a chave pública no campo indicado.",
                "rsa_err_invalid_key": "Formato de chave inválido. Use o JSON gerado pela aba 'Gerar Chaves'.",
                "rsa_err_msg_too_long": "Mensagem muito longa. Reduza o texto ou use cifragem híbrida.",

                # RSA Decrypt sub-page
                "rsa_decrypt_title": "Decifragem RSA-OAEP",
                "rsa_ciphertext_input_label": "Texto Cifrado (Base64)",
                "rsa_ciphertext_input_placeholder": "Cole o texto cifrado em Base64...",
                "rsa_privkey_input_label": "Chave Privada (cole o JSON)",
                "rsa_privkey_input_placeholder": '{"n": "...", "exp": "..."}',
                "rsa_decrypted_label": "Mensagem Decifrada",
                "rsa_btn_do_decrypt": "Decifrar",
                "rsa_btn_copy_decrypted": "Copiar Resultado",
                "rsa_err_no_cipher": "Cole o texto cifrado em Base64.",
                "rsa_err_no_privkey": "Cole a chave privada no campo indicado.",
                "rsa_err_decrypt_fail": "Falha na decifragem. Verifique a chave e o texto cifrado.",

                # RSA Sign/Verify sub-page
                "rsa_signverify_title": "Assinatura Digital RSA",
                "rsa_btn_mode_sign": "Assinar",
                "rsa_btn_mode_verify": "Verificar",
                "rsa_sign_msg_label": "Mensagem para Assinar",
                "rsa_sign_msg_placeholder": "Digite a mensagem a ser assinada...",
                "rsa_sign_privkey_label": "Chave Privada (cole o JSON)",
                "rsa_signed_doc_label": "Documento Assinado",
                "rsa_btn_do_sign": "Assinar Mensagem",
                "rsa_btn_copy_signed": "Copiar Documento",
                "rsa_verify_doc_label": "Documento Assinado (cole aqui)",
                "rsa_verify_doc_placeholder": "Cole o documento assinado (incluindo os delimitadores)...",
                "rsa_verify_pubkey_label": "Chave Pública (cole o JSON)",
                "rsa_btn_do_verify": "Verificar Assinatura",
                "rsa_verify_result_label": "Resultado da Verificação",
                "rsa_err_no_msg": "Insira a mensagem a ser assinada.",
                "rsa_err_no_privkey_sign": "Cole a chave privada no campo indicado.",
                "rsa_err_no_doc": "Cole o documento assinado.",
                "rsa_err_no_pubkey_verify": "Cole a chave pública no campo indicado.",
                "rsa_sign_ok": "Assinatura gerada com sucesso.",
                "rsa_verify_ok": "Assinatura VALIDA. A mensagem e autentica.",
                "rsa_verify_fail": "Assinatura INVALIDA.",
                "rsa_btn_back": "Voltar"
            },
            "en": {
                # Menu / Top Bar
                ...
                "app_title_rsa": "CryptoCational - RSA-OAEP",
                "rsa_home_title": "RSA-OAEP",
                "rsa_home_subtitle": "Asymmetric encryption with OAEP padding",
                "rsa_btn_keygen": "Generate Key Pair",
                "rsa_btn_encrypt": "Encrypt",
                "rsa_btn_decrypt": "Decrypt",
                "rsa_btn_sign_verify": "Sign / Verify",

                # RSA Keygen sub-page
                "rsa_keygen_title": "RSA-2048 Key Generation",
                "rsa_keygen_info": "Generates a 2048-bit RSA key pair (two 1024-bit primes) with public exponent e=65537. Generation may take a few seconds.",
                "rsa_keygen_btn": "Generate Key Pair",
                "rsa_keygen_generating": "Generating keys... please wait.",
                "rsa_keygen_done": "Key pair generated successfully.",
                "rsa_pubkey_label": "Public Key (JSON — copy to use for encryption)",
                "rsa_privkey_label": "Private Key (JSON — keep it secret!)",
                "rsa_privkey_warning": "Never share your private key.",
                "rsa_btn_copy_pub": "Copy Public Key",
                "rsa_btn_copy_priv": "Copy Private Key",

                # RSA Encrypt sub-page
                "rsa_encrypt_title": "RSA-OAEP Encryption",
                "rsa_plaintext_label": "Text to Encrypt",
                "rsa_plaintext_placeholder": "Enter message (max ~190 bytes for 2048-bit key)...",
                "rsa_pubkey_input_label": "Public Key (paste JSON)",
                "rsa_pubkey_input_placeholder": '{"n": "...", "exp": "..."}',
                "rsa_ciphertext_label": "Ciphertext (Base64)",
                "rsa_btn_do_encrypt": "Encrypt",
                "rsa_btn_copy_cipher": "Copy Result",
                "rsa_msg_limit": "Message limit: ~190 bytes for a 2048-bit key.",
                "rsa_err_no_text": "Enter the message to encrypt.",
                "rsa_err_no_pubkey": "Paste the public key in the designated field.",
                "rsa_err_invalid_key": "Invalid key format. Use the JSON generated in the 'Generate Keys' tab.",
                "rsa_err_msg_too_long": "Message too long. Shorten the text or use hybrid encryption.",

                # RSA Decrypt sub-page
                "rsa_decrypt_title": "RSA-OAEP Decryption",
                "rsa_ciphertext_input_label": "Ciphertext (Base64)",
                "rsa_ciphertext_input_placeholder": "Paste Base64 ciphertext here...",
                "rsa_privkey_input_label": "Private Key (paste JSON)",
                "rsa_privkey_input_placeholder": '{"n": "...", "exp": "..."}',
                "rsa_decrypted_label": "Decrypted Message",
                "rsa_btn_do_decrypt": "Decrypt",
                "rsa_btn_copy_decrypted": "Copy Result",
                "rsa_err_no_cipher": "Paste the Base64 ciphertext.",
                "rsa_err_no_privkey": "Paste the private key in the designated field.",
                "rsa_err_decrypt_fail": "Decryption failed. Check the key and ciphertext.",

                # RSA Sign/Verify sub-page
                "rsa_signverify_title": "RSA Digital Signature",
                "rsa_btn_mode_sign": "Sign",
                "rsa_btn_mode_verify": "Verify",
                "rsa_sign_msg_label": "Message to Sign",
                "rsa_sign_msg_placeholder": "Enter the message to sign...",
                "rsa_sign_privkey_label": "Private Key (paste JSON)",
                "rsa_signed_doc_label": "Signed Document",
                "rsa_btn_do_sign": "Sign Message",
                "rsa_btn_copy_signed": "Copy Document",
                "rsa_verify_doc_label": "Signed Document (paste here)",
                "rsa_verify_doc_placeholder": "Paste the signed document (including delimiters)...",
                "rsa_verify_pubkey_label": "Public Key (paste JSON)",
                "rsa_btn_do_verify": "Verify Signature",
                "rsa_verify_result_label": "Verification Result",
                "rsa_err_no_msg": "Enter the message to sign.",
                "rsa_err_no_privkey_sign": "Paste the private key in the designated field.",
                "rsa_err_no_doc": "Paste the signed document.",
                "rsa_err_no_pubkey_verify": "Paste the public key in the designated field.",
                "rsa_sign_ok": "Signature generated successfully.",
                "rsa_verify_ok": "Signature VALID. The message is authentic.",
                "rsa_verify_fail": "Signature INVALID.",
                "rsa_btn_back": "Back"
            }
        }
